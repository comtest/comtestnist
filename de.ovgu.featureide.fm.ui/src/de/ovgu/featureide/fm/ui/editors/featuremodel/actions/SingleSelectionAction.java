...
public abstract class SingleSelectionAction extends Action implements
	...
	protected ClassFeature classFeature;//Abhi
	protected ClassificationFeature classificationFeature; //Abhi
	protected CompositionFeature compositionFeature; //Abhi
	protected RangeClassFeature rangeClassFeature;//Abhi 
	...
	private void selectionChanged(boolean oneSelected) {
		...
		if (oneSelected) {
			...
			if(feature instanceof ClassificationFeature)
			{
				...
				classificationFeature.addListener(this);
			}
			else
