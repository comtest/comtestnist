 ...
 */
public class FeatureCreateCompositionLayerOperation extends AbstractFeatureModelOperation {
	...
	public FeatureCreateCompositionLayerOperation(Feature feature,
	...
	protected void redo() {
		...
		while (featureModel.getFeatureNames().contains("CompositionNode" + ++number));
		
		newFeature = new CompositionFeature(featureModel, "CompositionNode" + number);
