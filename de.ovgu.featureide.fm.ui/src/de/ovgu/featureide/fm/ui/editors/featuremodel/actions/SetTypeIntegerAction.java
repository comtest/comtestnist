...
import de.ovgu.featureide.fm.ui.editors.featuremodel.operations.SetTypeIntegerOperation;
 ...
 */
public class SetTypeIntegerAction extends SingleSelectionAction{
	...
	public SetTypeIntegerAction(Object viewer,
			FeatureModel featureModel, Object diagramEditor) {
		super("Integer", viewer);
		//Abhi
	...
	protected void updateProperties() {
		...
		if(feature instanceof ClassificationFeature)
		{
			...
			{
				if(classificationFeature.getDataType() == null || (!classificationFeature.getDataType().equalsIgnoreCase(FeatureConstants.TYPE_INTEGER)))
