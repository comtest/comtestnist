 ...
 */
public class CreateClassificationLayerAction extends SingleSelectionAction{
	...
	public CreateClassificationLayerAction(Object viewer,
			FeatureModel featureModel, Object diagramEditor) {
		super("Create Classification Node", viewer);
	...
	public void run() {
		//New 
		FeatureCreateClassificationLayerOperation op = new FeatureCreateClassificationLayerOperation(
