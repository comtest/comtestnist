...
import de.ovgu.featureide.fm.ui.editors.featuremodel.operations.FeatureCreateCompositionLayerOperation;
 ...
 */
public class CreateCompositionLayerAction extends SingleSelectionAction{
	...
	public CreateCompositionLayerAction(Object viewer,
			FeatureModel featureModel, Object diagramEditor) {
		super("Create Composition Node", viewer);
	...
	public void run() {
		//New 
		FeatureCreateCompositionLayerOperation op = new FeatureCreateCompositionLayerOperation(
