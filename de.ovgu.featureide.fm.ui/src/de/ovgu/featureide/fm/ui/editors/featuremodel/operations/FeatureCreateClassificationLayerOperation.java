 ...
 */
public class FeatureCreateClassificationLayerOperation extends AbstractFeatureModelOperation {
	...
	public FeatureCreateClassificationLayerOperation(Feature feature,
	...
	protected void redo() {
		...
		while (featureModel.getFeatureNames().contains("ClassificationNode" + ++number));
		
		newFeature = new ClassificationFeature(featureModel, "ClassificationNode" + number);
		...
		if(feature != null && feature.kind == FeatureKind.Composition)
		{
			feature.changeToAnd(); //Abhi
			newFeature.setMandatory(true); //Abhi
		}
