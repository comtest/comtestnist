...
public class FmOutlinePageContextMenu{
	...
	//private MandatoryAction mAction; //Abhi
	private AbstractAction aAction;
	//private DeleteAction dAction; //Abhi
	private DeleteAllAction dAAction;
	private RenameAction reAction;
	//private CreateCompoundAction cAction; //Abhi
	//private CreateLayerAction clAction; //Abhi
	private CreateClassificationLayerAction classfiAction; //Abhi
	private CreateClassLayerAction classAction; //Abhi
	private CreateCompositionLayerAction compAction; //Abhi
	private CreateConstraintAction ccAction;//Abhi
	private EditConstraintAction ecAction;
	//private OrAction oAction; //Abhi
	...
	private void initActions() {
		...
		//cAction = new CreateCompoundAction(viewer, fInput, fTextEditor.diagramEditor);//Abhi
		//clAction = new CreateLayerAction(viewer, fInput, fTextEditor.diagramEditor);//Abhi
		classfiAction = new CreateClassificationLayerAction(viewer, fInput, fTextEditor.diagramEditor);//Abhi
		classAction = new CreateClassLayerAction(viewer, fInput, fTextEditor.diagramEditor);//Abhi
		compAction = new CreateCompositionLayerAction(viewer, fInput, fTextEditor.diagramEditor);//Abhi
		reAction = new RenameAction(viewer, fInput, fTextEditor.diagramEditor);
		//oAction = new OrAction(viewer, fInput); //Abhi
		roAction = new ReverseOrderAction(viewer, fInput);
		//andAction = new AndAction(viewer, fInput);//Abhi
		...
		/*
		 * 
		 * Abhi - Commenting the Double Click Listener
	...
	private void addListeners() {
		//viewer.addDoubleClickListener(dblClickListener); //Abhi
	...
	protected void fillContextMenu(IMenuManager manager) {
		...
		if (sel instanceof FmOutlineGroupStateStorage) {
			//manager.add(andAction); //Abhi
			//manager.add(oAction); //Abhi
		...
		if (sel instanceof Feature) {
			...
			//manager.add(cAction); //Abhi
			
			//clAction.setText("Create Feature Below");
			//manager.add(clAction);//Abhi
			
			//Abhi
			classfiAction.setText("Create Classification Node Below");
			manager.add(classfiAction);
			
			//Abhi
			classAction.setText("Create Class Node Below");
			manager.add(classAction);
			
			//Abhi
			compAction.setText("Create Composition Node Below");
			manager.add(compAction);
			
			reAction.setChecked(false);
			reAction.setText("Rename");
			manager.add(reAction);
			
			//dAction.setText("Delete"); //Abhi
			//manager.add(dAction); //Abhi
