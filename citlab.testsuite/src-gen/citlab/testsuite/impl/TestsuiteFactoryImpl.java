...
public class TestsuiteFactoryImpl extends EFactoryImpl implements TestsuiteFactory {
	...
	public static TestsuiteFactory init() {
		try {
			TestsuiteFactory theTestsuiteFactory = (TestsuiteFactory)EPackage.Registry.INSTANCE.getEFactory("http://citlab.org/testsuite"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TestsuitePackage.ASSIGNMENT: return createAssignment();
			default:
