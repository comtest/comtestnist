 ...
 * <ul>
 *   <li>{@link citlab.testsuite.impl.TestImpl#getAssignments <em>Assignments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestImpl extends EObjectImpl implements Test {
	...
	public EList<Assignment> getAssignments() {
		if (assignments == null) {
			assignments = new EObjectResolvingEList<Assignment>(Assignment.class, this, TestsuitePackage.TEST__ASSIGNMENTS);
		}
		return assignments;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestsuitePackage.TEST__ASSIGNMENTS:
