...
abstract class TankManager$$Beschleunigung extends  TankManager$$Tools  {
	...
	public TankManager$$Beschleunigung (  ) { super(); }
...
abstract class TankManager$$einfrieren extends  TankManager$$Beschleunigung  {
	...
	public TankManager$$einfrieren (  ) { super(); }
	

}

abstract class TankManager$$Bombe extends  TankManager$$einfrieren  {
...
abstract class TankManager$$Energie extends  TankManager$$Bombe  {
	...
	public TankManager$$Energie (  ) { super(); }

}

abstract class TankManager$$Feuerkraft extends  TankManager$$Energie  {
...
abstract class TankManager$$Mars extends  TankManager$$Feuerkraft  {
	...
	public TankManager$$Mars (  ) { super(); }

}

abstract class TankManager$$explodieren extends  TankManager$$Mars  {
