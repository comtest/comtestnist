...
abstract class Tool$$Bombe extends  Tool$$einfrieren  {
	...
	public Tool$$Bombe ( TankManager tankManager, int x_Koordinate, int y_Koordinate, int toolType ) { super(tankManager, x_Koordinate, y_Koordinate, toolType); }

}

abstract class Tool$$Energie extends  Tool$$Bombe  {
	...
	public Tool$$Energie ( TankManager tankManager, int x_Koordinate, int y_Koordinate, int toolType ) { super(tankManager, x_Koordinate, y_Koordinate, toolType); }
}

abstract class Tool$$Feuerkraft extends  Tool$$Energie  {
