...
abstract class Maler$$Beschleunigung extends  Maler$$PC  {
	...
	public Maler$$Beschleunigung ( GameManager gameManager ) { super(gameManager); }

}

abstract class Maler$$einfrieren extends  Maler$$Beschleunigung  {
	...
	public Maler$$einfrieren ( GameManager gameManager ) { super(gameManager); }

}

abstract class Maler$$Bombe extends  Maler$$einfrieren  {
...
abstract class Maler$$Energie extends  Maler$$Bombe  {
	...
	public Maler$$Energie ( GameManager gameManager ) { super(gameManager); }

}

abstract class Maler$$Feuerkraft extends  Maler$$Energie  {
...
abstract class Maler$$Mars extends  Maler$$Feuerkraft  {
	...
	public Maler$$Mars ( GameManager gameManager ) { super(gameManager); }

}

abstract class Maler$$M_780 extends  Maler$$Mars  {
	...
	public Maler$$M_780 ( GameManager gameManager ) { super(gameManager); }

}

abstract class Maler$$fuer_PC extends  Maler$$M_780  {
...
abstract class Maler$$USA_M1Abrams extends  Maler$$Re_fuer_PC  {
	...
	public Maler$$USA_M1Abrams ( GameManager gameManager ) { super(gameManager); }
}

abstract class Maler$$Germany_Leopard extends  Maler$$USA_M1Abrams  {
	...
	public Maler$$Germany_Leopard ( GameManager gameManager ) { super(gameManager); }
}

public class Maler extends  Maler$$Germany_Leopard  {
